...
<div class="cards">
<?php
$cars = [["maker"=>"Toyota","model"=>"Carina","year"=>2001,"price"=>20000,"image"=>"https://d1hu588lul0tna.cloudfront.net/toyotaone/ruru/002-camry-exclusive-next-steps_tcm-3020-870114.jpg"],
    ...
    foreach($cars as $key){
        if($key['maker'] == $maker)
            print "<div class=\"card\">
                        <img width='100px' height='100px'  src=\"" . $key['image'] ."\"/>
                        <div class=\"description\">
                            <div class=\"title\">" .$key['maker']." ".$key['model']."</div>
...
<div class="menu">
<a href="task3.php">Home</a>|<a href="task93.php?maker=Toyota">Toyota</a>|<a href="task3.php?maker=BMW">BMW</a>|<a href="task93.php?maker=Audi">Audi</a>|<a href="task3.php?maker=Lada">Lada</a></div>
